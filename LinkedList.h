...
//       allocates new space for linknode head(sentinel node)
template <typename T>
...
//         creates space for head node (sentinel node)
template <typename T>
...
// gets data that head is currently pointing to
//return: linkedlist template type
...
// gets data that is at the end of linked list (currently pointing to null)
// return: linkedlist template type
